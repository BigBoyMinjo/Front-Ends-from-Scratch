  ...
  <body>
    ...
    <div class="index-main-box"> <!-- Main background picture -->
      ...
      <img id="phone" src="img/phone-main.jpg" alt="">
        <div id="about-us"><p id="txt"><span style="color: rgba(0, 227, 0, 1);"><b>Hungry</span> for some new cooking <span>knowledge?</span><br> No worries!<br> Just press this button and hire some amazing people to teach you something <span style="color: rgba(0, 227, 0, 1);">new</span> about <br> <span style="color: rgba(0, 255, 0, 1);">cooking</span> and <span style="color: rgba(0, 227, 0, 1);">drinks!</b></span></p></div>
      ...
      <div class="become-title">Become a chef or a bartender from the comfort of your home!</div>
        ...
        <div class="chefs-content-left">
          <ul class="lists">
            ...
            <li>Help others learn cooking better</li>
            <li>Get new experiences while working with clients from around the world!</li>
          </ul>
        </div>
        <div class="bartenders-content-right">
          <ul class="lists">
            <li>Earn extra money</li>
            <li>Help others learn the art of coktails</li>
            <li>Get new experiences while working with clients from around the world!</li>
          </ul>
        </div>
    ...
    <div class="footer">
      <ul class="uli">
        <li><a id="who" href="register-info.php"><span style="color: rgba(255, 255, 0, 1);">Become a chef/bartender</span></a></li>
